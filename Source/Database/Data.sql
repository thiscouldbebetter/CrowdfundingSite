...
/* ProjectID, UserIDOrganizer, Name, GoalInUsd, IsActive, Description */
insert into Project select 1, 1, 'Project Demo 1', 1000.00, true, NOW(), 'This is a demo project.';

/* An inactive project test. */
insert into Project select 999, 1, 'Project Demo 999', 1000.00, false, NOW(), 'This is an inactive demo project.';
